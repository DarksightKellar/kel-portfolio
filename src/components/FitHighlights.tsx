      ...
      <div ref={ref} className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="max-w-2xl text-base leading-7 text-zinc-700 dark:text-white/55">
            I am useful when the team knows the shape of the pain but not the system yet: half-specified product work, fragile production behavior, and workflows that need to become reliable without losing the human context.
          </p>
        </motion.div>
