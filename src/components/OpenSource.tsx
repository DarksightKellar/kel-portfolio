    ...
    <section id="github" className="border-t border-zinc-200 px-6 py-28 dark:border-white/5">
      <div ref={ref} className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.8fr_1.2fr]">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.5 }}>
          <p className="mb-4 text-sm uppercase tracking-[0.24em] text-zinc-500 dark:text-white/40">GitHub signal</p>
          <h2 className="text-4xl font-semibold tracking-[-0.04em] text-zinc-950 dark:text-white md:text-5xl">Not just private work.</h2>
          <p className="mt-5 text-base leading-7 text-zinc-700 dark:text-white/55">
            The public trail is uneven, like most real client-heavy careers, but it shows a consistent shape: Dart and Flutter libraries, Web3 protocol work, governance contracts, security-adjacent products, and automation.
          </p>
        </motion.div>
